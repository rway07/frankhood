$(document).ready(function() {
    $("#create_customer_form").validate({
        rules: {
            ...
            email: { email:true },
            enrollment_year: { required:true, digits:true, minlength:4, maxlength:4 },
        ...
        messages: {
            ...
            CAP: { required: "Inserire il CAP", maxlength: "Il CAP deve essere composto da 5 numeri" },
            province: { required: "Inserire la provincia" },
            phone: { digits: "Il numero di telefono deve essere composto solo da numeri" },
            mobile_phone: { digits: "Il numero di telefono deve essere composto solo da numeri" },
            email: { email: "email non valida"},
            enrollment_year: { required: "Inserire l'anno di iscrizione", digits: "Anno di iscrizione non valido",
                minlength: "Anno di iscrizione non valido", maxlength: "Anno di iscrizione non valido"}
        }
    });
});