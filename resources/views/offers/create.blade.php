...
<div class="card">
    ...
    <div class="card-body">
        ...
        @if (isset($offer))
            <form id="create_offer_form" action="/offers/{{ $offer->id }}/update" method="POST" class="form-horizontal">
                {{ method_field('PUT') }}
        @else
            <form id="create_offer_form" action="/offers/store" method="POST" class="form-horizontal">
        @endif
